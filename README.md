...
- Utility actions are distributed for faster access: `Test Audio File` and `Export Transcript` live in the top header setup row, while `Reset Session (F4)` is in the hotkey strip and translation-mode live bar.
