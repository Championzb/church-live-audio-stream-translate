...
- In Translation Mode, use the `Source` toggle pill in the translation hotkey row to show/hide the source-language caption panel; active highlight indicates the panel is visible. Main page layout remains unchanged.
