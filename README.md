...
- Rounded outer window shape now uses a subtle inset layout (`6px` margin around the main shell) so corner radius remains visible without black-edge artifacts.
