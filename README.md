...
- In Translation Mode, use the `SRC` hotkey-style pill in the translation hotkey row to show/hide the source-language caption panel. Main page layout remains unchanged.
