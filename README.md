...
- Entering Translation Mode now opens Source by default so Source and Target stay side-by-side for transcript comparison; each panel scrolls independently.
